...
import { Shield, Users, Globe, Award, CheckCircle, Briefcase, FileText, ArrowRight, MessageCircle } from 'lucide-react';
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-cream">
        ...
        <section className="relative z-30 -mt-10 md:-mt-16 mb-4 px-4">
        ...
        <section className="relative py-32 bg-fixed bg-center bg-cover" style={{ backgroundImage: `url('${ctaBgImg}')` }}>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            ...
            <motion.p variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportConfig} className="text-xl text-white/90 mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-500 text-white rounded-full hover:bg-green-600 transition-all hover:shadow-2xl hover:-translate-y-1 font-semibold text-lg"
              >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white rounded-full hover:bg-primary-hover transition-all hover:shadow-2xl hover:-translate-y-1 font-semibold text-lg"
              >
                Apply Now
                <ArrowRight size={20} />
              </Link>
