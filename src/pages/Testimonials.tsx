    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-b from-[#F8F7F3] to-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportConfig} className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-6 text-center shadow-xl border border-gray-100"
              >
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportConfig} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 shadow-lg relative border border-gray-100 cursor-default"
              >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={viewportConfig} className="bg-[#FAF7F2] rounded-3xl p-12 md:p-16 text-center border border-primary/10">
      ...
      <section className="py-20 bg-gradient-to-b from-[#F8F7F3] to-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={viewportConfig} className="grid md:grid-cols-3 gap-8">
            <motion.div variants={staggerItem} whileHover={hoverLift} className="bg-white rounded-2xl p-8 shadow-lg text-center cursor-default">
